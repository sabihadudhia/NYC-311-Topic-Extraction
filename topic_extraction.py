...
from text_vectorization import TEXT_COLUMN, load_corpus, vectorize_corpus
...
df, corpus = load_corpus(
    r"C:\Users\sabih\OneDrive\Desktop\Project - Data Analysis\preprocessed_data.csv",
...
tfidf_feature_names = vector_data['tfidf_feature_names']
...
for topic_num in range(n_topics):
    ...
    topic_docs = df[df['LDA_Topic'] == topic_num + 1][TEXT_COLUMN].head(3)
...
for cluster_num in range(1, n_clusters + 1):
    ...
    cluster_docs = df[df['KMeans_Cluster'] == cluster_num][TEXT_COLUMN].head(3)
